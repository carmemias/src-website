 ...
 * @param array $bulk_counts   Number of events selected to updated.
 * @return array Amended post update messages with new CPT update messages.
 */
function event_cpt_bulk_updated_messages( $bulk_messages, $bulk_counts ) {
	...
	$bulk_messages['event_cpt'] = array(
		...
		'updated'   => _n( '%s event updated.', '%s events updated.', $bulk_counts['updated'], 'events-functionality' ),
		// translators: number of events.
		'locked'    => _n( '%s event not updated, somebody is editing it.', '%s events not updated, somebody is editing them.', $bulk_counts['locked'], 'events-functionality' ),
		// translators: number of events.
		'deleted'   => _n( '%s event permanently deleted.', '%s events permanently deleted.', $bulk_counts['deleted'], 'events-functionality' ),
		// translators: number of events.
		'trashed'   => _n( '%s event moved to the Bin.', '%s events moved to the Bin.', $bulk_counts['trashed'], 'events-functionality' ),
		// translators: number of events.
		'untrashed' => _n( '%s event restored from the Bin.', '%s events restored from the Bin.', $bulk_counts['untrashed'], 'events-functionality' ),
	);
 ...
 *
 * @param object  $column Single column in the events table.
		...
		case 'event_cpt_type':
			...
			if ( $terms ) {
				foreach ( $terms as $term ) {
					$terms_list = $terms_list . $term->name . '</br>';}
			} else {
 ...
 *
 * @param array $columns Columns in the events table.
 */
...
/**
 * Make All Events table sortable by Event Type
 *
 * @param  object $query WP_Query object.
 */
