...
add_action( 'wp_footer', 'src_project_include_svg_icons', 9999 );
	...
	if ( 'social' === $args->theme_location ) {
		foreach ( $social_icons as $attr => $value ) {
			if ( false !== strpos( $item_output, $attr ) ) {
				$item_output = str_replace( $args->link_after, '</span>' . src_project_get_svg( array( 'icon' => esc_attr( $value ) ) ), $item_output );
			}
		}
	}
...
add_filter( 'walker_nav_menu_start_el', 'src_project_nav_menu_social_icons', 10, 4 );
...
add_filter( 'nav_menu_item_title', 'src_project_dropdown_icon_to_menu_link', 10, 4 );
 ...
 */
function src_project_social_links_icons() {
	 ...
	 */
	return apply_filters( 'src_project_social_links_icons', $social_links_icons );
}
