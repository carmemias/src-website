...
/*
Plugin Name: MyFontsWebfontsKit #3551378
...
add_action( 'admin_init', array('MyFontsInstaller_3551378','checkInstallation'));
add_action( 'wp_enqueue_scripts', array('MyFontsInstaller_3551378','mffonts_loadupWebfonts' ));